...
def museum_activity():
    ...
    return Activity("Art Museum", "museum", 2.0, 15.0,
                    (40.7128, -74.0060), "Modern art")


@pytest.fixture
def expensive_activity():
    '''Expensive activity for cost testing'''
    return Activity("Helicopter Tour", "tour", 2.0, 300.0,
                    (40.7128, -74.0060), "City tour")


@pytest.fixture
def free_activity():
    '''Free activity'''
    return Activity("Central Park", "nature", 1.5, 0.0,
                    (40.7829, -73.9654), "City park")


@pytest.fixture
def long_activity():
    '''Long duration activity'''
    return Activity("Day Trip", "tour", 8.0, 100.0,
                    (40.7128, -74.0060), "Full day tour")


@pytest.fixture
def short_activity():
    '''Short duration activity'''
    return Activity("Quick Visit", "museum", 0.5, 5.0,
                    (40.7128, -74.0060), "Brief tour")
...
def test_score_free_activity_with_cost_priority(
        free_activity, cost_priority_prefs):
...
def test_score_free_activity_without_cost_priority(
        free_activity, balanced_prefs, cost_priority_prefs):
...
def test_score_expensive_activity_without_cost_priority(
        expensive_activity, balanced_prefs, cost_priority_prefs):
    '''Test expensive activity when not prioritizing cost'''
    score_with_priority = score_activity(
        expensive_activity, cost_priority_prefs)
...
def test_score_variety_penalty_repeated_category(
        museum_activity, balanced_prefs):
